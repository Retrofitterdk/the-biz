<?php if ( has_nav_menu( $data->location ) ) : ?>
	...
	<nav <?php Hybrid\Attr\display( 'menu', $data->location, [ 'id' => 'site-navigation' ] ) ?>>
		<h3 class="menu__title">
			<a href="#" role="button" id="primary-menu-toggle" class="menu-toggle" aria-controls="primary-menu" aria-label="<?php esc_html_e( 'Close primary menu', 'finkom' ); ?>" aria-expanded="false">
				<?php Hybrid\Menu\display_name( $data->location ) ?>
			</a>
		</h3>
		<?php wp_nav_menu( [
